...
PROJECT_ID_MAINNET=radicle-dev/gnosis-safe-mainnet
PROJECT_ID_RINKEBY=radicle-dev/gnosis-safe-rinkeby
PROJECT_ID_ROPSTEN=radicle-dev/gnosis-safe-ropsten
